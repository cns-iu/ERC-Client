...
d3.spatialsankey = function() {
  ...
  spatialsankey.node = function(options){
    ...
    node_color_range = ["#0000a0", "#0000a0"];
    ...
    spatialsankey.nodeSizeArr.push((d.properties.aggregate_outflows/10) + (d.properties.aggregate_inflows/10)+10);
