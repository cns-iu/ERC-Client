    ...
    context.VisFunc = function() {
        ...
        context.updateNodeSize = function(arr,zoom,viz) {
            ...
            if (viz == "geomap"){
                      minNode.transition()
  	                     .duration(100)
                          .attr("r", context.geoNodeSizeMin/(prosym01.map.getZoom()-3)/10);
                      midNode.transition()
    	                 .duration(100)
                          .attr("r", context.geoNodeSizeMid/(prosym01.map.getZoom()-3)/10);
                      maxNode.transition()
    	                 .duration(100)
                          .attr("r", context.geoNodeSizeMax/(prosym01.map.getZoom()-3)/10);
            }
