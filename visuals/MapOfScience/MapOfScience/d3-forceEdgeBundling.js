...
(function() {
    ...
    d3.ForceEdgeBundling = function() {
        ...
        var forcebundle = function() {
                ...
                for (var i = 0; i < subdivision_points_for_edge.length; i++) {
                	for (var j = 0; j < subdivision_points_for_edge[i].length; j++) {
                		subdivision_points_for_edge[i][j].source = data_edges[i].source;
                		subdivision_points_for_edge[i][j].target = data_edges[i].target;
                	}
                }
